            ...
            <div class="panel panel-default" style="border-radius: 0px;">
                <div class="panel-body">
                    ...
                    <div class="form-group" >
                        <label class="col-md-offset-3 col-md-2 control-label">Task name</label>
                        <div class="col-md-5 col-md-offset-right-2 " style="margin-bottom: 1%;">
                            {!! Form::text('name', $task->tutor_name, array('class' => 'form-control')) !!}       
                        </div>
                    </div>  
                    <div class="form-group" >
                    ...
                    <div class="form-group" >
                        <label class="col-md-offset-3 col-md-2 control-label">Upload Solution</label>
                        <div class="col-md-5 col-md-offset-right-2 " style="margin-bottom: 1%;">
                    ...
                    <div class="form-group" >
                        <label class="col-md-offset-3 col-md-2 control-label">Help materials</label>
                        <div class="col-md-5 col-md-offset-right-2 " style="margin-bottom: 1%;">
